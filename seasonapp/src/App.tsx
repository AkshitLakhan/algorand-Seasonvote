...
function App() {
  ...
  const [likes1, setLikes1] = useState(faker.number.int({min:1,max:1000}));
  const [dislikes1, setDislikes1] = useState(faker.number.int({min:1,max:1000}));
  const [likes2, setLikes2] = useState(faker.number.int({min:1,max:1000}));
  const [dislikes2, setDislikes2] = useState(faker.number.int({min:1,max:1000}));
  const [likes3, setLikes3] = useState(faker.number.int({min:1,max:1000}));
  const [dislikes3, setDislikes3] = useState(faker.number.int({min:1,max:1000}));
  ...
  const app_address: number = 655256016;
  // CHANGE THIS TO YOUR APP ID
